    ...
    <>
      <div className="dvHeader shadow-sm sticky-top bg-colour6">
        <div className="dvStripe py-1">
          <div className="container-xl">
            <div className="row">
              ...
              <div
                id="lnkRegister"
                className="dvActivationInfo col-6 text-right col-lg-auto ml-lg-auto d-none d-lg-block  border-lg-right border-right-0"
              >
              ...
              <div id="lnkloginlogout" className="dvLoginInfo col-6 col-lg-auto d-none d-lg-block text-right">
              ...
              <div className="dvLanguageScript col-6 col-lg-auto text-right d-none">
        ...
        <div className="container-xl py-lg-3">
          <nav className="navbar navbar-expand-lg navbar-light px-0 py-2 mx-lg-n3 justify-content-start">
            <div className="logo m-0 col-auto col-lg-2 px-0 px-lg-3 order-0 order-lg-0">
              <a href="Index.aspx" className="d-inline-block pr-2 mr-1">
                <img src="/src/assets/images/logos/infinity-logo.svg" />
              </a>
            </div>
            <div className="logo m-0 col-auto col-lg-2 px-0 px-lg-3 order-1 order-lg-2 text-lg-right">
              <a href="https://www.abcbanking.mu/" target="_blank" className="d-inline-block">
                <img src="/src/assets/images/logos/abc-footer-logo.svg" />
              </a>
            </div>
            <div className="order-3 col-auto col-lg-auto align-items-center justify-content-end px-0 pr-lg-3 d-lg-none ml-auto">
              <button
                className="navbar-toggler d-lg-none px-0 py-2 border-0 ml-2"
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#navbarSupportedContent"
              >
                <i className="fa-solid fa-bars-staggered text-colour1">bar</i>
              </button>
            </div>

            <div
              className="navbar-collapse collapse order-3 order-lg-1 col-lg-auto px-0 px-lg-3 mb-1 mb-lg-0 justify-content-lg-end ml-auto"
